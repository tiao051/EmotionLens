...
//            Console.WriteLine("Starting the ImgConsumer service.");

//            await StartProcessing(stoppingToken);

//            _logger.LogInformation("ImgConsumer is now listening to RabbitMQ.");
//            Console.WriteLine("ImgConsumer is now listening to RabbitMQ.");
//        }
...
//                _logger.LogInformation("Waiting for img messages from RabbitMQ...");
